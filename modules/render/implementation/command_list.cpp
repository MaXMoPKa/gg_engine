...
namespace gg
{
    ...
    void CommandList::copyResource(Microsoft::WRL::ComPtr<ID3D12Resource> dst_resource, Microsoft::WRL::ComPtr<ID3D12Resource> src_resource)
    {
        ...
        this->d3d12_command_list->CopyResource(dst_resource.Get(), src_resource.Get());
                                         ...
                                         uint32_t dst_subresource, uint32_t src_subresource)
    {
        ...
        this->d3d12_command_list->ResolveSubresource(dst_resource->getD3D12Resource().Get(), dst_subresource,
        ...
        , pipeline_state{nullptr}
    {
        ...
        throwIfFailed(d3d12_device->CreateCommandAllocator(this->d3d12_command_list_type, IID_PPV_ARGS(&this->d3d12_command_allocator)));
        throwIfFailed(d3d12_device->CreateCommandList(0, this->d3d12_command_list_type, this->d3d12_command_allocator.Get(), nullptr, IID_PPV_ARGS(&this->d3d12_command_list)));
        ...
        for(int i = 0; i < D3D12_DESCRIPTOR_HEAP_TYPE_NUM_TYPES; ++i)
        {
            ...
            d3d12_descriptor_heaps[i] = nullptr;
        }
    }
    ...
    {
        throwIfFailed(this->d3d12_command_allocator->Reset());
        throwIfFailed(this->d3d12_command_list->Reset(this->d3d12_command_allocator.Get(), nullptr));
